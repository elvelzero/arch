...
# cp -r /home/urUserName/my/downloads/clone/config/.config/{bash,conky,i3lock-color,kitty,npm,picom,ranger,rofi,nvim,vim,wgetrc,X11,xmobar,xmonad,zathura} .config/
rsync -r /home/urUserName/downloads/clone/config/.config/{bash,conky,i3lock-color,kitty,npm,picom,ranger,rofi,nvim,vim,wgetrc,X11,xmobar,xmonad,zathura} .config/
